...
- link:../interfaces/trainer-create.adoc[POST /trainer/] azonosítójú Edző rögzítése elnevezésű interfészt az alábbi mapping megvalósításával
...
- link:../interfaces/trainer-delete.adoc[DELETE /trainer/{id}] azonosítójú Edző törlése elnevezésű interfészt az alábbi mapping megvalósításával
