...
| Kiváltó esemény
| A felhasználó módosítani kívánja a kiválasztott kliens metaadatait.
...
| Eredmény
| A felhasználó látja a kliens módosított metaadatait.
...
| Kliens módosítása| CLIENT_UPDATE| Kliens
